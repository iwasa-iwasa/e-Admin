    ...
    <Dialog :open="open" @update:open="handleClose">
        <DialogContent class="max-w-3xl max-h-[90vh]">
            <DialogHeader>
                ...
                <DialogDescription
                    >部署内共有カレンダーに予定を追加します</DialogDescription
                >
            </DialogHeader>
                    ...
                    >
                        <div class="flex items-center space-x-2">
                            <Checkbox
                                id="allDay"
                                :checked="isAllDay"
                                @update:checked="isAllDay = $event"
                            />
                            <Label for="allDay" class="text-sm cursor-pointer"
                                >終日</Label
                            >
                        </div>
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <Select @update:model-value="handleAddParticipant">
                                ...
                                <SelectContent>
                                    <SelectItem
                                        v-for="member in availableMembers.filter(
                                            (m) =>
                                                !participants.find(
                                                    (p) => p.id === m.id
                                                )
