...
<template>
    <div class="relative">
        <input
            ...
            class="rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:focus:border-indigo-600 dark:focus:ring-indigo-600 autofill:dark:bg-gray-800 autofill:dark:text-gray-200 pr-10"
            v-model="model"
            ref="input"
            v-bind="$attrs"
        />
