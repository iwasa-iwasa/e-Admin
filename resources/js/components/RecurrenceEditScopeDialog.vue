      ...
      <div class="space-y-4">
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-3 flex items-start gap-2">
          ...
          <div class="text-sm text-amber-800">
            ...
            <p class="text-amber-700">{{ new Date(eventDate).toLocaleDateString('ja-JP') }}</p>
          </div>
        </div>
        ...
        <div class="space-y-3">
          ...
          <div class="flex items-start space-x-3 p-3 border rounded-lg hover:bg-gray-50 bg-blue-50 border-blue-200">
            <input type="radio" v-model="selectedScope" value="all" id="all" class="mt-1" />
            <div class="flex-1">
              <Label for="all" class="font-medium cursor-pointer">すべての予定</Label>
              <p class="text-sm text-gray-600 mt-1">
