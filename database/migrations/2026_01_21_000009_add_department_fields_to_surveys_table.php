    ...
    public function up(): void
    {
        ...
        if (DB::getDriverName() !== 'sqlite') {
            ...
            if (DB::getDriverName() === 'mysql') {
                $indexesFound = collect(DB::select('SHOW INDEX FROM surveys'))->pluck('Key_name')->toArray();
            }

            Schema::table('surveys', function (Blueprint $table) use ($indexesFound) {
                if (!in_array('idx_surveys_visibility_dept', $indexesFound)) {
